...
# Create directories for the segmentation workflow
RUN mkdir -p /home/datascience /in /out /src && \
    mkdir -p /tmp/bucket_in_folder /tmp/bucket_out_folder && \
    chmod 777 /home/datascience /in /out /src /tmp/bucket_in_folder /tmp/bucket_out_folder

# Create symbolic links for compatibility with SAT
RUN mkdir -p /home/nibio && \
    ln -sf /tmp /home/nibio/mutable-outside-world
